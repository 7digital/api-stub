...
conventions.id = underscore.bind(conventions.fileNamedAfterParameter, conventions, function idMatcher(paramName) {
	return endsWith('id', paramName.toLowerCase());
});

conventions.tags = underscore.bind(conventions.fileNamedAfterParameter, conventions, function idMatcher(paramName) {
	return paramName.toLowerCase() === 'tags';
});

conventions.search = underscore.bind(conventions.fileNamedAfterParameter, conventions, function idMatcher(paramName) {
