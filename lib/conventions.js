...
function findIdParameterOrDefault(req) {
	var result = findIdParameter(req)
...
ConventionalHandler.prototype.idOrDefault = ConventionalHandler.prototype.fileNamedAfterParameter.bind(ConventionalHandler, findIdParameterOrDefault);
