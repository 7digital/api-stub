...
function CardRegistration() {
	...
	return {
		...
		checkRegistrationId: function checkRegistrationId(req, res, next) {
			...
			if (registrations[id].cardExpiryMonth === '01' && registrations[id].cardExpiryYear === '2013') {
				fileNameEnding = 'cardExpiryDateInvalid';
			}
			if (registrations[id].cardExpiryMonth === '02' && registrations[id].cardExpiryYear === '2013') {
